...
<div class="col-12 d-flex justify-content-center">
  ...
  <div class="login-card card-block auth-body">
    <form class="md-float-material" method="post" action="{{ route('customer-register-save') }}">
      {!! csrf_field() !!}
      ...
      <div class="auth-box z-depth-5">
        ...
        <div class="input-group">
          <input type="text" class="form-control" placeholder="Nama pengguna" name="username" value="{{old('username')}}" required>
          <span class="md-line"></span>
        </div>
        <div class="input-group">
          <input type="text" class="form-control" placeholder="Nomor kontak" name="contact" value="{{old('contact')}}" required>
          <span class="md-line"></span>
        </div>
        <div class="input-group">
